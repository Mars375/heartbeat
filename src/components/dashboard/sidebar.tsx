...
export function Sidebar() {
  ...
  return (
    <aside className="flex h-full w-60 flex-col bg-bg-surface-1/80 backdrop-blur-xl border-r border-[#353534]/40">
      ...
      <div className="h-px bg-[#353534]/40 mx-3" />
      <nav aria-label="Dashboard navigation" className="flex flex-1 flex-col gap-0.5 p-3 pt-3">
